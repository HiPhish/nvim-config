...
M.modes = {
	...
	noV      = {label = 'NORMAL'         , short = ' N ', hi = 'Normal'},
	['no\022'] = {label = 'NORMAL'         , short = ' N ', hi = 'Normal'},
	...
	['\022']   = {label = 'VISUAL BLOCK'   , short = '[V]', hi = 'Visual'},
	['\022s']  = {label = 'VISUAL BLOCK'   , short = '[V]', hi = 'Visual'},
	s        = {label = 'SELECT'         , short = ' s ', hi = 'Select'},
	S        = {label = 'SELECT LINE'    , short = ' S ', hi = 'Select'},
	['\019']   = {label = 'SELECT BLOCK'   , short = '[S]', hi = 'Select'},
